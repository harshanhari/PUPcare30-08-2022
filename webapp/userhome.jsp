		...
		<nav
			...
			<div class="collapse navbar-collapse justify-content-between px-3"
				...
				<div class="navbar-nav mr-auto py-0">
					<a href="userhome.jsp" class="nav-item nav-link active">Home</a> <a
					...
					<a href="selling_status.jsp" class="nav-item nav-link">Selling
						...
						<div class="p-3" style="max-width: 900px;">
							...
							<h1 style="color: white;">
								...
								try {
									...
									.prepareStatement("select user_registration_name from user_registration where user_registration_email=?");
									ps.setString(1, username);
									ResultSet rs = ps.executeQuery();
									while (rs.next()) {
										out.print("Welcome back " + rs.getString(1));
