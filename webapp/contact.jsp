		...
		<nav
			...
			<div class="collapse navbar-collapse justify-content-between px-3"
				...
				<div class="navbar-nav mr-auto py-0">
					...
					<a href="addfeedback.jsp" class="nav-item nav-link">Feedback</a>
			...
			<div>
				<center>
					...
					<div style="color: black;">
						...
						<p>Phone Number : +91 7994962059 , +91 9495507209</p>
						<p>Email : harshanharijithu@gmail.com</p>
						<p>Address : Indeevaram,Avalukunnu P.O Alappuzha</p>
				</center>
			</div>
		</div>
	</div>
