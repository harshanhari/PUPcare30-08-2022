...
<body>
	...
	<div class="col-md-8" style="padding-top: 20px; margin: auto;">
		<div class="card mb-3"
			...
			<div class='signup'>
				<form name="form3" action="show_puppies.jsp">
					<center>
						<h4>Select breed</h4>
						<br>
						<br>
						<select name="breed" id="breed" style="font-size: large;">
							<%
							...
							%>
						</select><br><br> <input type="submit" id="buy" value="Buy"
