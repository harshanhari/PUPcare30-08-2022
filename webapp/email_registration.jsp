...
<body>
	...
	<div class="col-md-8" style="padding-top: 20px; margin: auto;">
		<div class="card mb-3"
			...
			<h2 style="color: Black; text-align: center; margin-bottom: 50px;">
				<u>Add a valid email id</u>

			</h2>
			<div class='signup' style="text-align: center;">

				<form name="vinform" action="emailfinder.jsp">


					<label style="margin-left: 30px; color: black;"> <b>Email
							: </b>
					</label> <input type='email' placeholder='Enter your email' /id="email"
						name="email" style="margin-left: 30.5px;"> <br> <br>
