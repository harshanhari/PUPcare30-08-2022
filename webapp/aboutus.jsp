...
%>
		...
		<nav
			...
			<div class="collapse navbar-collapse justify-content-between px-3"
				...
				<div class="navbar-nav mr-auto py-0">
					...
					<a href="buy_puppy.jsp" class="nav-item nav-link">Buy Puppies</a> <a
						href="sellpuppies.jsp" class="nav-item nav-link">Sell
						Puppies</a> <a href="selling_status.jsp" class="nav-item nav-link">Selling
						Status</a><a href="aboutus.jsp" class="nav-item nav-link active">About</a>
					...
					<a href="contact.jsp" class="nav-item nav-link">Contact</a> <a
						href="addfeedback.jsp" class="nav-item nav-link">Feedback</a>
					<a href="logout.jsp" onclick="alert('Successfully signout');" class="nav-item nav-link">Sign out</a>
	...
	<div class="col-md-8" style="padding-top: 20px; margin: auto;">
		<div class="card mb-3"
			style="border: solid black; margin: auto; padding: 20px;">
			<div>
				<center>
					<h4>
						<u>About Our Dog Care Services</u>
					</h4>
				</center>
				<p style="color: black;">PUPcare system came into being as an
					idea to help people raise their pets. CEO & Founder, Harshan Hari
					has been an avid dog lover and a breeder all his life. While
					working at his developer job, he was frequently asked to advise on
					pet keeping. He identified the knowledge gap and thought it would
					be a great idea to start putting this information in the public
					domain and involve other pet owners to share their experiences as
					well. PUPcare system started as an online community that told
					people to care puppies, breeding and raising pets in the Indian
					context.</p>
			</div>
		</div>
	</div>
