...
<body>
		...
		<nav
			...
			<div class="collapse navbar-collapse justify-content-between px-3"
				...
				<div class="navbar-nav mr-auto py-0">
					...
					<a href="selling_status.jsp" class="nav-item nav-link">Selling Status</a><a
						href="aboutus.jsp" class="nav-item nav-link">About</a>
					...
					<a href="contact.jsp" class="nav-item nav-link">Contact</a> <a
						href="addfeedback.jsp" class="nav-item nav-link active">Feedback</a>
					<a href="logout.jsp" onclick="alert('Successfully signout');"
	...
	<div class="col-md-8" style="padding-top: 20px; margin: auto;">
		<div class="card mb-3"
			...
			<div class='box'
				style="margin: auto; width: 50%; padding-bottom: 20px;">
				<h4>
					<u>Feedback Form</u>
				</h4>
				<div style="font: 1em Helvetica">
					<form onsubmit="return validate()" action="AddFeedbackServlet1"
						method="post">
						<input type='text' placeholder='Name :' / id="name" name="name"
							style="width: 270px;"> <br> <br>
						<textarea name="feedback" id="feedback"
							placeholder="Enter your feedback"
							style="height: 100px; width: 270px; background-color: white;"></textarea>
						<br> <br> <input type='submit' id="
							save"
							value="Save"
							style="background-color: #ff6037; border: none; color: white; padding: 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: auto; cursor: pointer; border-radius: 4px; width: 133px;">
						<input type='reset' placeholder='RESET' /id="reset"
							style="background-color: #ff6037; border: none; color: white; padding: 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: auto; cursor: pointer; border-radius: 4px; width: 132px;"><br>
